...
public class Offre implements Serializable, Comparable<Offre> {
	...
	/*
	 * private String nomEtablissement; private Float reductionSup; private
	 * Image illustration; private Categorie categorie; private Time
	 * heureDebutOffre; private Time heureFinOffre; private Integer priorite;
	...
	public int compareTo(Offre offre2) {
		...
		float dist1 = distFrom(this.latitude, this.longitude,
				(float) user.getPosition().latitude,
				(float) user.getPosition().longitude);
		float dist2 = distFrom(offre2.latitude, offre2.longitude,
				(float) user.getPosition().latitude,
				(float) user.getPosition().longitude);
	...
	/*
	 * public Drawable getDImage(){ if(this.dImage == null){ this.dImage = new
	 * WebService().getImageFromURL(this.image); } return this.dImage; }
	 * 
	 * public void setDImage(Drawable theDImage){ this.dImage = theDImage; }
	 */

	/*
	 * public Time getHeureDebutOffre() { return heureDebutOffre; }
	 * 
	 * public Time getHeureFinOffre() { return heureFinOffre; }
	 * 
	 * public Coordonnee getProximity() { return null; }
	 */

	/*
	 * public Float getReducPrix() { return reductionSup; }
	 */
	...
	/*
	 * public String getTitreLong() { return titreLong; }
	 */

	/*
	 * public String getDescriptionCourt() { return descriptionCourt; }
	 */
}